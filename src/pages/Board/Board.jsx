...
import AddCardModal from "../../components/AddCarModal/AddCardModal";
...
const BoardPage = () => {
  ...
  const getGradient = (card) => {
    ...
    if (title === "TODO") {
      ...
      return {
        background:
          "linear-gradient(63.35deg, rgba(65,65,65,0.67) -1.72%, rgba(220,48,48) 163.54%)",
      };
    } else if (title === "Completed") {
      return {
        background:
          "linear-gradient(65.35deg, rgba(65,65,65,0.67) -1.72%, rgba(48,220,220) 86.54%)",
      };
      ...
      <div className='board-container'>
        ...
        <Board
          ...
          renderColumnHeader={(props) => {
            ...
            const handleCarAdd = (title, detail) => {
              const card = {
                id: new Date().getTime(),
                title,
                description: detail,
